    ...
    if (interaction.commandName === 'informalbot') {
        ...
        switch (action) {
            ...
            case 'stop':
                ...
                await interaction.reply({
                    content: `🛑 **Salamanca Informal Bot deactivated for #${channelName}**\n\nBot will no longer monitor this channel.`,
                    ephemeral: false
                });
